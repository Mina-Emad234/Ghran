...
class SiteImageController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.site_image.create',compact('sections'));
    }

    public function store(SiteImageRequest $request)
    {
        try{
            $section=SiteSection::withCount('image')->with('image')->where('section_type','images')->find($request->site_section_id);
            if(!$section)
