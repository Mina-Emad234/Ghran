 ...
 * To use it on other terms please contact us at tags@jeasyui.com
 *
 */
(function($){
function _1(_2){
...
bb.num=$("<input class=\"pagination-num\" type=\"text\" value=\"2\" size=\"2\">").appendTo(tr).wrap("<td></td>");
...
$("<div class=\"pagination-tags\"></div>").appendTo(_5);
...
$(_15).find("div.pagination-tags").html(_1c);
if(bb.first){
