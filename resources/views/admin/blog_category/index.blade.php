        ...
        <div class="content">
            ...
            <table class="dataGrid tableSorter boxStyle" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr @if($counter % 2 == 1)
                    ...
                    <td title="">
                        <a title="تعديل البيانات" class="tool boxStyle" href="{{route('category.edit',$cat->id)}}"  ><img src="{{asset('admins/images/icons/Pencil.png')}}" alt="تعديل" /></a>
                        <a title="حذف " class="tool boxStyle" href="{{route('category.delete',$cat->id)}}" class="delete_confirm"  onclick="return confirm('هل تريد حذف هذا العنصر؟');"><img src="{{asset('admins/images/icons/Trash.png')}}" alt="حذف"  /></a>
                    </td>
                </tr>
                @php
                $counter++
