...
@section('content')
    ...
    <div id="middleContent">
        <div class="block">
            <div class="title lightTextShadow">المتقدمين للكورسات</div>
                ...
                <table class="dataGrid tableSorter boxStyle" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr
                        ...
                        <td class="align-center">
                            <a href="{{route('c_applicant.read',$applicant->id)}}"> <img title="قراءة محتوى الرسالة" src="{{asset('admins/images/balloon.gif')}}"  /></a>&nbsp;&nbsp; | &nbsp;&nbsp;
                            <a href="{{route('c_applicant.delete',$applicant->id)}}" onclick="return confirm('هل تريد حذف هذا العنصر؟')"><img src="{{asset('admins/images/del.png')}}" width="16" height="16" title="حذف" alt="حذف"  /></a>
                        </td>
                    </tr>
                    @php
                    $counter++;
