...
<div id="middleContent">
    ...
    <div class="block">
        ...
        <div class="content">
            <a href="{{route('site_section.create')}}" class="button sub inlineBlock rnd3 lightTextShadow">
            ...
            <table class="dataGrid tableSorter boxStyle" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr @if($counter % 2 == 1)
                    ...
                    <td title="">
                        <a title="تعديل البيانات" class="tool boxStyle" href="{{route('site_section.edit',$section->id)}}"  ><img src="{{asset('admins/images/icons/Pencil.png')}}" alt="تعديل" /></a>
                        <a title="حذف " class="tool boxStyle" href="{{route('site_section.delete',$section->id)}}" class="delete_confirm"  onclick="return confirm('هل تريد حذف هذا العنصر؟');"><img src="{{asset('admins/images/icons/Trash.png')}}" alt="حذف"  /></a>
                    </td>
                </tr>
                @php
                $counter++
